0 REM DESCRIPTION: 4 in a Row program with AI that plays against you
1 REM CATEGORY: Games
2 REM SOURCE: https://zxbasic.readthedocs.io/en/docs/examples/4inarow.bas 
3 REM COMMENT: Adapted by JGalego, from MicroHOBBY magazine, Num. 18, page 27  :')
4 BORDER 1: PAPER 1: INK 7: CLS : PRINT AT 10,10; FLASH 1;"STOP THE TAPE": PAUSE 200
